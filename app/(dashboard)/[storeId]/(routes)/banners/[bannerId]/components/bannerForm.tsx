...
import { useCreateBannerMutation, useDeleteBannerMutation, useUpdateBannerMutation } from "@/redux/features/banner/bannerApi";
...
export const BannerForm: React.FC<BannerFormProps> = ({ initialData }) => {
  ...
  const onSubmit = async (data: BannerFormValues) => {
    ...
    if (initialData) {
      const res: any = await updateBanner({ id, data });
      ...
      const res: any = await createBanner(bannerData);
